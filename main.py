...
def find_vector_analysis():
    ...
    print("\n\nPopulation Size (20% of vectors): ", size_population)
    print("Vector Analysis Time: ", (time.time() - start_time)*1000, "ms")
    print("Number of Generation: ", count_iteration)
...
print("Final without duplicates: ")
...
print("Time to find most covered Vectors: ", (time.time() - now_time)*1000, "ms")

print("Number of Covered Vectors: ", len(result))
